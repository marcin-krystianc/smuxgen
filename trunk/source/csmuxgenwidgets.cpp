...
/////////////////////////////////////////////////////////////////////////////
void cImageList::dragEnterEvent(QDragEnterEvent *event)
{
...
/////////////////////////////////////////////////////////////////////////////
void cImageList::dragMoveEvent(QDragMoveEvent *event)
{
    if (event->mimeData()->hasFormat(tileMimeFormat())) {
...
/////////////////////////////////////////////////////////////////////////////
void cImageList::dropEvent(QDropEvent *event)
{
...
/////////////////////////////////////////////////////////////////////////////
void cImageList::addPiece(const QPixmap &pixmap)
{
    ...
    this->trace(QString("addPiece count:")+QString::number(this->count()),traceLevel3);
...
/////////////////////////////////////////////////////////////////////////////
void cImageList::addPieceSlot(const QPixmap &pixmap)
{
    this->addPiece(pixmap);
}
/////////////////////////////////////////////////////////////////////////////
    ...
    : QWidget (parent)
{
    ...
    connect(this->imageDownloader[0]    ,SIGNAL(signalImage(const QPixmap&))  , this->imagelist, SLOT(addPieceSlot(const QPixmap&)));
    connect(this->imageDownloader[1]    ,SIGNAL(signalImage(const QPixmap&))  , this->imagelist, SLOT(addPieceSlot(const QPixmap&)));
    ...
    : QWidget (parent)
{
    ...
    this->imageSearch = new cImageSearch(this);
    QHBoxLayout *l0 = new QHBoxLayout;
    l0->addWidget(this->imageSearch);
